...
Ktmin = 0.001;      Ktmax = 0.0573;     % Reducción en la generación de torque
cmin = 2;       cmax = 40;
Kbmin = 0.001;      Kbmax = 0.0566;
Lmin = 0.8*L;  Lmax = 1.2*L;
Rmin = 0.6*R;  Rmax = R; 
alfa1 = 0.2;
alfa2 = 0.2;
alfa3 = 0.2;
...
Kbb = [ Kbmin
        Kbmin + alfa3*(Kbmax-Kbmin)
        Kbmax ];

LL = [ Lmin
       Lmin + alfa4*(Lmax-Lmin)
       Lmax ];
   
RR = [ Rmin
       Rmin + alfa5*(Rmax-Rmin)
       Rmax ];

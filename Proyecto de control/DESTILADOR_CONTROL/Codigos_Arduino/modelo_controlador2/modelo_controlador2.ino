...
void setup() {
  ...
  analogReadResolution(10);   // set the analog input resolution to 10 bit
...
//    else if(Xb>1) Xb =1;
    ...
    Serial.print(Xd*100.0);
    Serial.print("x");
    Serial.print(Xb*100.0);
    Serial.print("y");
    Serial.print(u_L*100.0);
    Serial.println("z");
...
//    Serial.print(Xb);
//    Serial.print("  ");
//    Serial.print(int_e_xd);
//    Serial.print("  ");
//    Serial.print(int_e_xb);
//    Serial.println("  ");

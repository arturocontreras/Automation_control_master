...
figure(4);
plot(t,xx,'-r',t,xxh,'-b',t,sensorsuma,'-k',t,sensor1,'--g',t,sensor2,'--y',t,sensor3,'--m',t,sensor4,'*m');
legend('xx','xxh','sensorsuma','sensor1','sensor2','sensor3','sensor4')
grid;

...
#define Vmax 0.4 
#define ymax 1.0 //1
#define u_amin 780 //121 //DAC out minimo
#define u_amax 3100//606 //DAC out minimo
...
void loop() {
  ...
  //**************Leer ADC y escalar u *******************************
   if((millis()-tiempo) > Tm){
    ...
    u_L = (u_L_analog-u_amin)*Lmax/(u_amax-u_amin); //Escalamiento de u_L
    u_V = (u_V_analog-u_amin)*Vmax/(u_amax-u_amin); //Escalamiento de u_V
   ...
   if( u_V_analog > 1500){
    ...
    analogWrite(DAC1, 0);  // write the selected waveform on DAC0
   }

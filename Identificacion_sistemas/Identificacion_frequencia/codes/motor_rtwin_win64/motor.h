...
typedef struct {
  ...
  real_T Startintegration;             /* '<Root>/Start integration' */
...
typedef struct {
  real_T DigitalFilter_states[50];     /* '<S1>/Digital Filter' */
  real_T lastSin;                      /* '<Root>/sin(wt)' */
  real_T lastCos;                      /* '<Root>/sin(wt)' */
  real_T lastSin_d;                    /* '<Root>/cos(wt)' */
  real_T lastCos_o;                    /* '<Root>/cos(wt)' */
  struct {
    void *LoggedData;
  ...
  int32_T DigitalFilter_circBuf;       /* '<S1>/Digital Filter' */
  int32_T systemEnable;                /* '<Root>/sin(wt)' */
  int32_T systemEnable_g;              /* '<Root>/cos(wt)' */
} DW_motor_T;
...
#define rtPrevZCSigState               motor_PrevZCX
#define PrevZCSigStates                PrevZCX_motor_T
...
struct P_motor_T_ {
  ...
  real_T AnalogInput_YieldWhenWaiting; /* Expression: YieldWhenWaiting
                                        * Referenced by: '<S2>/Analog Input'
                                        */
  real_T Constant_Value;               /* Expression: id_motor.bias
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T sinwt_Amp;                    /* Expression: 1
                                        * Referenced by: '<Root>/sin(wt)'
                                        */
  real_T sinwt_Bias;                   /* Expression: 0
                                        * Referenced by: '<Root>/sin(wt)'
                                        */
  real_T sinwt_Freq;                   /* Expression: id_motor.w
                                        * Referenced by: '<Root>/sin(wt)'
                                        */
  ...
  real_T Integrator1_IC;               /* Expression: 0
                                        ...
                                        */
  real_T coswt_Amp;                    /* Expression: 1
                                        * Referenced by: '<Root>/cos(wt)'
                                        */
  real_T coswt_Bias;                   /* Expression: 0
                                        * Referenced by: '<Root>/cos(wt)'
                                        */
  real_T coswt_Freq;                   /* Expression: id_motor.w
                                        * Referenced by: '<Root>/cos(wt)'
                                        */
  ...
  real_T coswt_PCos;                   /* Computed Parameter: coswt_PCos
                                        * Referenced by: '<Root>/cos(wt)'
                                        */
  real_T Step_Time;                    /* Expression: id_motor.Tstop
...
/* Zero-crossing (trigger) state */
extern PrevZCX_motor_T motor_PrevZCX;

/* Model entry point functions */
extern RT_MODEL_motor_T *motor(void);
 ...
 *
 * '<Root>' : 'motor'
 * '<S1>'   : 'motor/Digital Filter Design'
 * '<S2>'   : 'motor/MOTOR DC '
 * '<S3>'   : 'motor/Digital Filter Design/Check Signal Attributes'
 */

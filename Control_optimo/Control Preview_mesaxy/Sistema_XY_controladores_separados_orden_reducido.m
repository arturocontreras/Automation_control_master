...
q2o = input('Peso q2o (Vel) : ');
q3o = input('Peso q3o (I)  : ');
Qo = diag([ q2o q3o ]);
...
for tt = ti:dt:tf
   ...
   %%%%Motor X%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
   x_sal(kc,1) = C*x + 0.001*rand(1,1);%medición posicion en motor X  
...
for tt = ti:dt:tf
   ...
   y_sal(kc,1) = C*y + 0.001*rand(1,1);%medición posicion en motor X
